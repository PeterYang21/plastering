...
# print(RawMetadata.objects(srcid='1636')[0]["metadata"])
...
class ZodiacAPI(Resource):
    ...
    def post(self):
        ...
        zodiac.update_model([srcid])
        zodiac.learn_model() # todo: learn after update ?

# todo: pred = zodiac.predict()
api.add_resource(ZodiacAPI, '/')
app.run(debug=True)
